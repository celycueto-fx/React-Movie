...
import ImagenComponent from '../../app/components/ImagesIconsSearchComponent/ImagesIcons';
import { ContainerSummary, ImageDiv } from '../../assets/StylesComponents/ContainerSummary';
import { ENDPOINT_URL_IMAGES, ENPOINT_SEARCH_API } from '@/app/enviroments/EndoPoints';
import { API_KEY, IMAGE_NOFOUND_URL } from '@/utils/Constants';
import { ContainerCard, ImageHome } from './MoviesHomeStyle';
